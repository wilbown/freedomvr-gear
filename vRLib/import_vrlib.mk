...
LOCAL_EXPORT_C_INCLUDES := \
  $(LOCAL_PATH)/src/main/jni/LibOVR/Include \
  $(LOCAL_PATH)/src/main/jni/LibOVR/Src \
  $(LOCAL_PATH)/src/main/jni/3rdParty/TinyXml \
  $(LOCAL_PATH)/src/main/jni/3rdParty/minizip \
  $(LOCAL_PATH)/src/main/jni
