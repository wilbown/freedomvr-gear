...
void OvrProgressBarComponent::OneTimeInit( OvrVRMenuMgr & menuMgr, VRMenuObject * self, const Vector4f & color )
{
	...
	VRMenuObject * base = menuMgr.ToObject( self->ChildHandleForId( menuMgr, ProgressBarBaseId ) );
	if ( base != NULL )
	{
...
eMsgStatus OvrProgressBarComponent::OnEvent_Impl( App * app, VrFrame const & vrFrame, OvrVRMenuMgr & menuMgr,
