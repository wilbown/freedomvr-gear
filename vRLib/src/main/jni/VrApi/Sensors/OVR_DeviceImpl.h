...
enum
{
    ...
    Samsung_VendorId = 0x04E8,
    Device_KTracker_Samsung_ProductId_0 = 0xA500,		// First release of GearVR Innovator Edition.
	Device_KTracker_Samsung_ProductId_1 = 0xA501,		// Following are reserved (supported in the HID driver).
	Device_KTracker_Samsung_ProductId_2 = 0xA502,
	Device_KTracker_Samsung_ProductId_3 = 0xA503,
	Device_KTracker_Samsung_ProductId_4 = 0xA504,
...
public:
    ...
    virtual int GetThreadTid() const = 0;
    virtual void SuspendThread() const = 0;
    virtual void ResumeThread() const = 0;
